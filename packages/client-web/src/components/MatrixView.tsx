...
type Props = {
  ...
  // Phase 3 O.8: Resolver-Maps (cells/rows/cols/objects-Maps) fuer
  // Live-Aufloesung von Name-Templates im NewCellWizard.
  resolverMaps?: () => import('../lib/label-template').ContextMaps;
};
